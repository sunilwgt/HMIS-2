...
import { DocumentListComponent } from '../compmodules/document/document-list/document-list.component';
...
export class MenuService implements OnInit {
  ...
  public getPopupMenuItems(): Array<ComponentInfo> {
    return [
      ...
      {
        compName: ComponentModule[ComponentModule.DocumentModule],
        compId: ComponentModule.DocumentModule,
        comp: new ComponentRef(DocumentComponent),
        routeLink: RL_DOCUMENT,
  ...
  private getCompList(): Array<ComponentInfo> {
    return [
      ...
      {
        compName: ComponentModule[ComponentModule.DocumentListModule],
        compId: ComponentModule.DocumentListModule,
        comp: new ComponentRef(DocumentListComponent),
      ...
      {
        compName: ComponentModule[ComponentModule.SchedulingListModule],
        compId: ComponentModule.SchedulingListModule,
