...
import { RL_REGISTRATION, MODE_STATE, MODE_ADD, ACTION_BUTTON_STATE, ADD, RL_USERTYPE } from '../../../models/common';
...
@Component({
  selector: 'app-usertypeheader-buttons',
  templateUrl: './usertypeheader-buttons.component.html',
  styleUrls: ['./usertypeheader-buttons.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class UserTypeHeaderButtonsComponent implements OnInit {
...
setdate(f, t) {
  ...
  private addnewusertype(): void {
    this._state.currentstate = MODE_ADD;
    this._state.stateData = null;
    this.baseservice.compLoadManager.redirect(RL_USERTYPE)
