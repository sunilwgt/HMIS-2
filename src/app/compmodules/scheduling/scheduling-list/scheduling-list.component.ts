...
export class SchedulingListComponent extends BaseComponent implements OnInit {
  ...
  private createAppointment(): void {
    ...
    this.openCompInAddMode(RL_SCHEDULING)
    // this.compLoadManager.redirect(RL_SCHEDULING);
  }
