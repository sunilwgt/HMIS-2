...
@Component({
  selector: 'app-permissionheader-buttons',
  templateUrl: './permissionheader-buttons.component.html',
  styleUrls: ['./permissionheader-buttons.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PermissionHeaderButtonsComponent implements OnInit {
