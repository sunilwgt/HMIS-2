...
import { RL_REGISTRATION, MODE_STATE, MODE_ADD, ACTION_BUTTON_STATE, ADD, RL_USERTYPE, RL_USER, RL_PERMISSION } from '../../../models/common';
...
@Component({
  selector: 'app-assignpermissionheader-buttons',
  templateUrl: './assignpermissionheader-buttons.component.html',
  styleUrls: ['./assignpermissionheader-buttons.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class AssignPermissionHeaderButtonsComponent implements OnInit {
...
setdate(f, t) {
  ...
  private addnewpermission(): void {
    this._state.currentstate = MODE_ADD;
    this._state.stateData = null;
    this.baseservice.compLoadManager.redirect(RL_PERMISSION)
