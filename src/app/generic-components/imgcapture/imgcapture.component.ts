...
export class ImgcaptureComponent implements OnInit, OnDestroy {
  ...
  private takeSnapshot() {
    ...
    //  console.log('take snapshot' , blobData);
    //  var myFile = this.blobToFile(blobData, "my-image.png");
    //  console.log('myFile' , myFile);
    this.externalApi.setimageblob(blobData);
    // this.externalApi.loadProfileImage(blobData,'id' ,"patientimage.jpg");
